...
public class StepRepositoryCustomImpl implements StepRepositoryCustom {
    ...
    //------------------------------------------- 마이페이지 스텝 조회-------------------------------------------------------
    @Override
    public StepCountForAllDto countMyStepsForAllRegions(String nickname) {
        ...
        List<Object[]> results = entityManager.createQuery(
                        "SELECT s.province, COUNT(s) FROM Step s WHERE s.user = :user GROUP BY s.province", Object[].class)
    ...
    @Override
    public StepCountForSeoulDto countMyStepsForSeoul(String nickname) {
        User user = entityManager.createQuery(
                        "SELECT u FROM User u WHERE u.nickname = :nickname", User.class)
                .setParameter("nickname", nickname)
                .getSingleResult();
        ...
        List<Object[]> results = entityManager.createQuery(
                        "SELECT s.district, COUNT(s) FROM Step s WHERE s.province = 'Seoul' AND s.user = :user GROUP BY s.district", Object[].class)
                .setParameter("user", user)
                .getResultList();
    ...
    public StepCountForBusanDto countMyStepsForBusan(String nickname) {
        User user = entityManager.createQuery(
                        "SELECT u FROM User u WHERE u.nickname = :nickname", User.class)
                .setParameter("nickname", nickname)
                .getSingleResult();
        ...
        List<Object[]> results = entityManager.createQuery(
                        "SELECT s.district, COUNT(s) FROM Step s WHERE s.province = 'Busan' AND s.user = :user GROUP BY s.district", Object[].class)
                .setParameter("user", user)
                .getResultList();
    ...
    public StepCountForGyeonggiDto countMyStepsForGyeonggi(String nickname) {
        List<Object[]> results = entityManager.createQuery(
                        "SELECT s.district, COUNT(s) FROM Step s WHERE s.province = 'Gyeonggi' GROUP BY s.district", Object[].class)
                .getResultList();
